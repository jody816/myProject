...
<body>
	<div id="container">
		<h1 id="heading">캡틴 방패 그립톡</h1>
		<div id="prod-pic">
			<img src="/pptest/images/cap1.jpg" alt="캡틴아메리카 그립톡" id="cup" width="200" height="200">
			<div id="small-pic"> 
				<img src="/pptest/images/cap1.jpg" class="small">
				<img src="/pptest/images/cap1-1.jpg" class="small">
				<img src="/pptest/images/cap1-2.jpg" class="small">
	 	  </div>
		</div>			
		<div id="desc">
