...
<body>
	<div id="container">
		<h1 id="heading">캡틴 방패 USB</h1>
		<div id="prod-pic">
			<img src="/pptest/images/cap5.jpg" alt="캡틴아메리카 USB" id="cup" width="200" height="200">
			<div id="small-pic"> 
				<img src="/pptest/images/cap5.jpg" class="small">
				<img src="/pptest/images/cap5-1.jpg" class="small">
				<img src="/pptest/images/cap5-2.jpg" class="small">
	 	  </div>
		</div>			
		<div id="desc">
