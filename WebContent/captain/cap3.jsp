...
<body>
	<div id="container">
		<h1 id="heading">캡틴아메리카 에어팟 케이스</h1>
		<div id="prod-pic">
			<img src="/pptest/images/cap3.jpg" alt="캡틴아메리카 에어팟 케이스" id="cup" width="200" height="200">
			<div id="small-pic"> 
				<img src="/pptest/images/cap3.jpg" class="small">
				<img src="/pptest/images/cap3-1.jpg" class="small">
				<img src="/pptest/images/cap3-2.jpg" class="small">
	 	  </div>
		</div>			
		<div id="desc">
