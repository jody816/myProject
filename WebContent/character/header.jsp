 ...
 <header id="main-header"> 
     ...
     <nav id="main-navigation"> 
        <ul> 
            ...
            <li><a href="allChar.jsp">CHARACTERS</a></li>  
        </ul> 
    </nav>
    <div id="main-h">
        <header>
            <div>
                <label for="checkbox" style=background-color:#fff>▼</label>
                <h1>Sort&nbsp;→&nbsp;</h1>
            </div>
            ...
            <nav>
                <ul>
                    <li>
                    <a href="allChar.jsp">ALL</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="ironMan.jsp">IronMan</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="spiderMan.jsp">SpiderMan</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="deadPool.jsp">DeadPook</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="carnage.jsp">Carnage</a>
                    </li>
                </ul>
            </nav>
        </header>
