...
<body>
	<div id="container">
		<h1 id="heading">토르 묠니르 USB</h1>
		<div id="prod-pic">
			<img src="/pptest/images/thor2.jpg" alt="토르 묠니르 USB" id="cup" width="200" height="200">
			<div id="small-pic"> 
				<img src="/pptest/images/thor2.jpg" class="small">
				<img src="/pptest/images/thor2-1.jpg" class="small">
				<img src="/pptest/images/thor2-2.jpg" class="small">
	 	  </div>
		</div>			
		<div id="desc">
