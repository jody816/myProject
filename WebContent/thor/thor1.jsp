...
<body>
	<div id="container">
		<h1 id="heading">토르 묠니르 키링</h1>
		<div id="prod-pic">
			<img src="/pptest/images/thor1.jpg" alt="토르 묠니르 키링" id="cup" width="200" height="200">
			<div id="small-pic"> 
				<img src="/pptest/images/thor1.jpg" class="small">
				<img src="/pptest/images/thor1-1.jpg" class="small">
				<img src="/pptest/images/thor1-2.jpg" class="small">
	 	  </div>
		</div>			
		<div id="desc">
