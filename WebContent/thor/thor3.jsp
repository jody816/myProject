...
<body>
	<div id="container">
		<h1 id="heading">토르 묠니르 에어팟 케이스</h1>
		<div id="prod-pic">
			<img src="/pptest/images/thor3.jpg" alt="토르 묠니르 에어팟 케이스" id="cup" width="200" height="200">
			<div id="small-pic"> 
				<img src="/pptest/images/thor3.jpg" class="small">
				<img src="/pptest/images/thor3-1.jpg" class="small">
				<img src="" class="small">
	 	  </div>
		</div>			
		<div id="desc">
