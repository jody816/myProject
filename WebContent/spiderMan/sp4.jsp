...
<body>
	<div id="container">
		<h1 id="heading">스파이더맨 스피커</h1>
		<div id="prod-pic">
			<img src="/pptest/images/spider man4.jpg" alt="스파이더맨 스피커" id="cup" width="200" height="200">
			<div id="small-pic"> 
				<img src="/pptest/images/spider man4.jpg" class="small">
				<img src="/pptest/images/spider man4-1.jpg" class="small">
				<img src="/pptest/images/spider man4-2.jpg" class="small">
	 	  </div>
		</div>			
		<div id="desc">
