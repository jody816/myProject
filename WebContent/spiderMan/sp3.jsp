...
<body>
	<div id="container">
		<h1 id="heading">스파이더맨 게이밍 의자</h1>
		<div id="prod-pic">
			<img src="/pptest/images/spider man1.jpg" alt="스파이더맨 의자" id="cup" width="200" height="200">
			<div id="small-pic"> 
				<img src="/pptest/images/spider man3.jpg" class="small">
				<img src="/pptest/images/spider man3-1.jpg" class="small">
				<img src="/pptest/images/spider man3-2.jpg" class="small">
	 	  </div>
		</div>			
		<div id="desc">
