...
<body>
	<div id="container">
		<h1 id="heading">스파이더맨 종합 피규어</h1>
		<div id="prod-pic">
			<img src="/pptest/images/spider man1.jpg" alt="스파이더맨 피규어" id="cup" width="200" height="200">
			<div id="small-pic"> 
				<img src="/pptest/images/spider man1.jpg" class="small">
				<img src="/pptest/images/spider man1-1.jpg" class="small">
				<img src="/pptest/images/spider man1-2.jpg" class="small">
	 	  </div>
		</div>			
		<div id="desc">
