...
<body>
	<div id="container">
		<h1 id="heading">타노스 피규어2</h1>
		<div id="prod-pic">
			<img src="/pptest/images/thanos2.jpg" alt="타노스 피규어" id="cup" width="200" height="200">
			<div id="small-pic"> 
				<img src="/pptest/images/thanos2.jpg" class="small">
				<img src="/pptest/images/thanos2-1.jpg" class="small">
				<img src="/pptest/images/thanos2-2.jpg" class="small">
	 	  </div>
		</div>			
		<div id="desc">
