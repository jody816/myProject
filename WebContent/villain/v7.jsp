...
<body>
	<div id="container">
		<h1 id="heading">옐로우자켓 피규어1</h1>
		<div id="prod-pic">
			<img src="/pptest/images/yellow.jpg" alt="옐로우 자켓 피규어" id="cup" width="200" height="200">
			<div id="small-pic"> 
				<img src="/pptest/images/yellow.jpg" class="small">
				<img src="/pptest/images/yellow1.jpg" class="small">
				<img src="/pptest/images/yellow2.jpg" class="small">
	 	  </div>
		</div>			
		<div id="desc">
