...
<body>
	<div id="container">
		<h1 id="heading">크로스본즈 피규어1</h1>
		<div id="prod-pic">
			<img src="/pptest/images/bone.jpg" alt="크로스 본즈 피규어" id="cup" width="200" height="200">
			<div id="small-pic"> 
				<img src="/pptest/images/bone.jpg" class="small">
				<img src="/pptest/images/bone-1.jpg" class="small">
				<img src="/pptest/images/bone-2.jpg" class="small">
	 	  </div>
		</div>			
		<div id="desc">
