...
<body>
	<div id="container">
		<h1 id="heading">울트론 피규어1</h1>
		<div id="prod-pic">
			<img src="/pptest/images/ult.jpg" alt="울트론 피규어" id="cup" width="200" height="200">
			<div id="small-pic"> 
				<img src="/pptest/images/ult.jpg" class="small">
				<img src="/pptest/images/ult1.jpg" class="small">
				<img src="/pptest/images/ult2.jpg" class="small">
	 	  </div>
		</div>			
		<div id="desc">
