...
<body>
	<div id="container">
		<h1 id="heading">베놈 피규어1</h1>
		<div id="prod-pic">
			<img src="/pptest/images/venom.jpg" alt="베놈 피규어" id="cup" width="200" height="200">
			<div id="small-pic"> 
				<img src="/pptest/images/venom.jpg" class="small">
				<img src="/pptest/images/venom1.jpg" class="small">
				<img src="/pptest/images/venom2.jpg" class="small">
	 	  </div>
		</div>			
		<div id="desc">
