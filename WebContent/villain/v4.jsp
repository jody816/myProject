...
<body>
	<div id="container">
		<h1 id="heading">인피니티 건틀렛 키링</h1>
		<div id="prod-pic">
			<img src="/pptest/images/thanos3.jpg" alt="인피니티 건틀렛 키링" id="cup" width="200" height="200">
			<div id="small-pic"> 
				<img src="/pptest/images/thanos3.jpg" class="small">
				<img src="/pptest/images/thanos3-1.jpg" class="small">
				<img src="/pptest/images/thanos3-2.jpg" class="small">
	 	  </div>
		</div>			
		<div id="desc">
