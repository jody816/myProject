...
<body>
 <header id="main-header"> 
        <div class="header-menu"> 
            <ul class="outer-menu"> 
                <li> 
                    <a href="/pptest/admin.jsp"><img alt="관리자 페이지" src="/pptest/images/menu.png" width=30 height=30></a> 
                    <ul class="inner-menu"> 
                        <li><a href="memberInfo.do">회원 정보</a></li>
        				<li><a href="orderListAdmin.do">회원 주문</a></li>
     ...
     <nav id="main-navigation"> 
        <ul> 
            <li><a href="/pptest/movie.jsp">NEWS</a></li> 
