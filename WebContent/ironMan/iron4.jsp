...
<body>
	<div id="container">
		<h1 id="heading">아이언맨 LEGO</h1>
		<div id="prod-pic">
			<img src="/pptest/images/iron man4.jpg" alt="아이언맨 LEGO" id="cup" width="200" height="200">
			<div id="small-pic"> 
				<img src="/pptest/images/iron man4.jpg" class="small">
				<img src="/pptest/images/iron man4-1.jpg" class="small">
				<img src="/pptest/images/iron man4-2.jpg" class="small">
	 	  </div>
		</div>			
		<div id="desc">
