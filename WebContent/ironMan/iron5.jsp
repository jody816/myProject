...
<body>
	<div id="container">
		<h1 id="heading">헐크버스터 피규어</h1>
		<div id="prod-pic">
			<img src="/pptest/images/iron man5.jpg" alt="헐크버스터 피규어" id="cup" width="200" height="200">
			<div id="small-pic"> 
				<img src="/pptest/images/iron man5.jpg" class="small">
				<img src="/pptest/images/iron man5-1.jpg" class="small">
				<img src="/pptest/images/iron man5-2.jpg" class="small">
	 	  </div>
		</div>			
		<div id="desc">
