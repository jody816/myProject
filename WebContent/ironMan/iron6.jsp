...
<body>
	<div id="container">
		<h1 id="heading">헐크버스터 스피커</h1>
		<div id="prod-pic">
			<img src="/pptest/images/iron man6.jpg" alt="헐크버스터 스피커" id="cup" width="200" height="200">
			<div id="small-pic"> 
				<img src="/pptest/images/iron man6.jpg" class="small">
				<img src="/pptest/images/iron man6-1.jpg" class="small">
				<img src="/pptest/images/iron man6-2.jpg" class="small">
	 	  </div>
		</div>			
		<div id="desc">
