...
<body>
	<div id="container">
		<h1 id="heading">아이언맨 그립톡</h1>
		<div id="prod-pic">
			<img src="/pptest/images/iron man7.jpg" alt="아이언맨 피규어" id="cup" width="200" height="200">
			<div id="small-pic"> 
				<img src="/pptest/images/iron man7.jpg" class="small">
				<img src="/pptest/images/iron man7-1.jpg" class="small">
				<img src="/pptest/images/iron man7-2.jpg" class="small">
	 	  </div>
		</div>			
		<div id="desc">
