...
<body>
	<div id="container">
		<h1 id="heading">아이언맨 피규어</h1>
		<div id="prod-pic">
			<img src="/pptest/images/iron man1-1.jpg" alt="아이언맨 피규어" id="cup" width="200" height="200">
			<div id="small-pic"> 
				<img src="/pptest/images/iron man1-1.jpg" class="small">
				<img src="/pptest/images/iron man1-2.jpg" class="small">
				<img src="/pptest/images/iron man1-3.jpg" class="small">
	 	  </div>
		</div>			
		<div id="desc">
