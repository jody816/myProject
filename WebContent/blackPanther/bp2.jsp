...
<body>
	<div id="container">
		<h1 id="heading">블랙팬서 차량용 USB</h1>
		<div id="prod-pic">
			<img src="/pptest/images/black panther2.jpg" alt="블랙팬서 USB" id="cup" width="200" height="200">
			<div id="small-pic"> 
				<img src="/pptest/images/black panther2.jpg" class="small">
				<img src="/pptest/images/black panther2-1.jpg" class="small">
				<img src="/pptest/images/black panther2-2.jpg" class="small">
	 	  </div>
		</div>			
		<div id="desc">
