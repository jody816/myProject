...
<body>
	<div id="container">
		<h1 id="heading">블랙팬서 게이밍 의자</h1>
		<div id="prod-pic">
			<img src="/pptest/images/black panther7-1.jpg" alt="블랙팬서 의자" id="cup" width="200" height="200">
			<div id="small-pic"> 
				<img src="/pptest/images/black panther7-1.jpg" class="small">
				<img src="/pptest/images/black panther7-2.jpg" class="small">
				<img src="/pptest/images/black panther7-3.jpg" class="small">
	 	  </div>
		</div>			
		<div id="desc">
