...
<body>
	<div id="container">
		<h1 id="heading">블랙팬서 의자왕 피규어</h1>
		<div id="prod-pic">
			<img src="/pptest/images/black panther3.jpg" alt="블랙팬서 피규어" id="cup" width="200" height="200">
			<div id="small-pic"> 
				<img src="/pptest/images/black panther3.jpg" class="small">
				<img src="/pptest/images/black panther3-1.jpg" class="small">
				<img src="/pptest/images/black panther3-2.jpg" class="small">
	 	  </div>
		</div>			
		<div id="desc">
