...
<body>
	<div id="container">
		<h1 id="heading">블랙팬서 스피커</h1>
		<div id="prod-pic">
			<img src="/pptest/images/black panther5.jpg" alt="블랙팬서 스피커" id="cup" width="200" height="200">
			<div id="small-pic"> 
				<img src="/pptest/images/black panther5.jpg" class="small">
				<img src="/pptest/images/black panther5-1.jpg" class="small">
				<img src="/pptest/images/black panther5-2.jpg" class="small">
	 	  </div>
		</div>			
		<div id="desc">
