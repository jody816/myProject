...
<body>
	<div id="container">
		<h1 id="heading">헐크 피규어1</h1>
		<div id="prod-pic">
			<img src="/pptest/images/hulk1.jpg" alt="헐크 피규어" id="cup" width="200" height="200">
			<div id="small-pic"> 
				<img src="/pptest/images/hulk1.jpg" class="small">
				<img src="/pptest/images/hulk1-1.jpg" class="small">
				<img src="/pptest/images/hulk1-2.jpg" class="small">
	 	  </div>
		</div>			
		<div id="desc">
