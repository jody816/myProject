...
<body>
	<div id="container">
		<h1 id="heading">헐크 피규어2</h1>
		<div id="prod-pic">
			<img src="/pptest/images/hulk2.jpg" alt="헐크 피규어" id="cup" width="200" height="200">
			<div id="small-pic"> 
				<img src="/pptest/images/hulk2.jpg" class="small">
				<img src="/pptest/images/hulk2-1.PNG" class="small">
				<img src="/pptest/images/hulk2-2.PNG" class="small">
	 	  </div>
		</div>			
		<div id="desc">
